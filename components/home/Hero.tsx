...
export default function Hero() {
  ...
  return (
    <section
      ref={heroRef}
      id="inicio"
      className="relative min-h-[100svh] overflow-hidden bg-[#f8fbff] pt-20"
    >
      {/* BACKGROUND */}
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute left-[48%] top-[20%] hidden h-32 w-32 rounded-full border border-[#0755c7]/10 lg:block" />

        <div className="absolute left-[52%] top-[25%] hidden h-16 w-16 rounded-full border border-[#0755c7]/10 lg:block" />
      </div>

      <div className="relative mx-auto grid min-h-[calc(100svh-80px)] max-w-[1500px] items-center gap-14 px-5 pb-14 pt-10 md:px-8 md:pb-16 md:pt-14 lg:grid-cols-[1.02fr_0.98fr] lg:gap-16 lg:px-12 xl:px-16">
        {/* ============================================================
            LEFT
        ============================================================ */}
        ...
        >
          ...
          >
            <a
              href="#servicos"
              className="group flex min-h-14 items-center justify-center gap-3 rounded-full bg-[#0755c7] px-7 py-4 font-semibold text-white shadow-[0_15px_35px_rgba(7,85,199,0.18)] transition-all duration-300 hover:-translate-y-1 hover:bg-[#064aaa] hover:shadow-[0_20px_45px_rgba(7,85,199,0.25)]"
            >
              Conhecer serviços
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -bottom-5 left-2 z-20 flex items-center gap-3 rounded-2xl border border-white/50 bg-white/95 px-4 py-3 shadow-[0_20px_45px_rgba(6,43,97,0.14)] backdrop-blur md:-left-8 md:bottom-16 md:px-5 md:py-4"
          >
          ...
          <motion.div
            ...
            className="absolute -right-2 top-[19%] z-20 hidden items-center gap-3 rounded-2xl border border-white/50 bg-white/95 px-4 py-3 shadow-[0_20px_45px_rgba(6,43,97,0.12)] backdrop-blur sm:flex md:-right-8"
          >
