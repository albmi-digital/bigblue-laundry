...
const DepthCarousel = ({
  ...
  */
   ...
   * IMPORTANTE:
   *
   * Inicializamos cfgRef aqui para que já tenha valores válidos
   * durante o primeiro render.
   *
   * Depois será atualizado num useEffect.
   */
  ...
  const wheelTimerRef = useRef<ReturnType<typeof setTimeout> | null>(
    null,
  );
  ...
  */
  ...
  /*
  |--------------------------------------------------------------------------
  | REFRESH LAYOUT WHEN PROPS CHANGE
  |--------------------------------------------------------------------------
  */
